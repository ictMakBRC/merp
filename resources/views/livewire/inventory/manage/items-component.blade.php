<div>
                        ...
                        <div class="row mb-2">
                            <x-inventory.table-utilities>
                                <div class="text-sm-end mt-1 ms-auto position-relative">
                                    <a type="button" href="#" class="btn btn-primary mb-2 me-1"
                                        data-bs-toggle="modal" data-bs-target="#addData">Add New</a>
                                </div>
                            </x-inventory.table-utilities>
                        </div>
                    </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table-action">
                                                        @if ($value->is_active == 1)
                                                            <span
                                                                class="badge badge-success-lighten float-center">Active</span>
                                                            @php(($satate = 'Active') and ($Stvalue = 1))
                                                        @elseif($value->is_active == 0)
                                                            <span
                                                                class="badge badge-danger-lighten float-center">InActive</span>
                                                            @php(($satate = 'InActive') and ($Stvalue = 0))
                                                        @endif
                                                    </td>
                                                    <td class="table-action">
                                                        <a href="javascript: void(0);"
                                                            class="action-ico text-info mx-1"> <i class="mdi mdi-pencil"
    ...
    <div class="modal fade" wire:ignore.self id="delete_modal" data-bs-backdrop="static" data-bs-keyboard="false"
        tabindex="-1" aria-labelledby="staticBackdropLabeld" aria-hidden="true">
    ...
    <!-- ADD NEW Items Modal -->
    <div class="modal fade" wire:ignore.self id="addData" data-bs-backdrop="static" data-bs-keyboard="false"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="inv_subunit_id" id="subunit" onchange="makeCode()"
                                                    wire:model.lazy="inv_subunit_id" class="form-control">
                                                    <option value="">Select</option>
                                                    @if (count($subcat) > 0)
                                                        @foreach ($subcat as $sub)
                                                            <option value="{{ $sub->id }}">
                                                                {{ $sub->subunit_name }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="item_code" class="form-control"
                                                    name="item_code" wire:model.differ="item_code" required>
                                                @error('item_code')
                                                    <div class="text-danger text-small">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select " id="inv_uom_id" name="inv_uom_id"
                                                    wire:model.lazy="inv_uom_id" required>
                                                    <option value="">Select</option>
                                                    @if (count($uoms) > 0)
                                                        @foreach ($uoms as $uom)
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select " id="supplier_id" name="supplier_id"
                                                    wire:model.lazy="supplier_id" wire:model="supplier_id">
