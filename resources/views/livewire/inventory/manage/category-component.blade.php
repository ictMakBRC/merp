            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card-header pt-0">
                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-end mt-3">
                                <a type="button" href="#" class="btn btn-primary mb-2 me-1" data-bs-toggle="modal" data-bs-target="#addData">Add Category</a>
                            </div>
                        </div><!-- end col-->
                    </div>
                </div>
        ...
        <div class="modal fade" wire:ignore.self id="delete_modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabeld" aria-hidden="true">
         ...
         <div class="modal fade" wire:ignore.self data-bs-backdrop="static"  id="editData" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="EditData">Edit Category</h5>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="CategoryName"  class="form-control" name="subunit_name" wire:model="subunit_name" required>
                                        @error('subunit_name')
                        ...
                        <form wire:submit.prevent="storeData" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="mb-3">
                                        <label for="CategoryName" class="form-label">Category Name</label>
                                        <input type="text" id="CategoryName" name="subunit_name" wire:model='subunit_name' class="form-control"  required>
                                        @error('subunit_name')
                                        <div class="text-danger text-small">{{ $message }}</div>
                                        @enderror
                                    </div>
