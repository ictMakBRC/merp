                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <form method="POST" action="{{ url('inventory/request/updateState') }}">
                                                            @csrf
                                                        ...
                                                        <div class="wrapperb">
                                                            <input type="radio" name="approve" value="signed" id="option-1" required onchange="mycomment()">
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            document.getElementById('comments').value="Signed";
                                            document.getElementById('itemstate').value="open";
