                        ...
                        <div class="row mb-2">
                            <div class="col-sm-4">
                                <div class="text-sm-end mt-3">
                                   <h4 class="header-title mb-3  text-center"> MakBRC Category</h4>
                               </div>
                           </div>
                           <div class="col-sm-8">
                            <div class="text-sm-end mt-3">
                                <a type="button" href="#" class="btn btn-primary mb-2 me-1" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Add Category</a>
                            </div>
                        </div><!-- end col-->
                    </div>
                </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="table-action">
                                            ...
                                            <a onclick="return confirm('Are you sure you want to delete?');" href="{{ url('inventory/delete-unit/'.$value->id) }}"  data-toggle="tooltip" title="Delete!" class="action-icon"> <i class="mdi mdi-delete"></i></a>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="{{ url('inventory/update-unit/'.$value->id) }}" method="POST">
                                                                    @csrf
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <input type="text" id="CategoryName" value="{{ $value->name}}" class="form-control" name="unit_name">
                                                                            </div>
                                                                            <div class="mb-3">
 ...
 <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ url('inventory/addUnit') }}" method="POST">
                    @csrf
