...
class DocumentAllRequestsComponent extends Component
{
    use  WithPagination;
    public $perPage = 10;
    ...
    public function render()
    {
        ...
        return view('livewire.document-management.document-all-requests-component', $data)->layout('livewire.document-management.layouts.app');
    }
}
