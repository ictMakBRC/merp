...
class UofMeasureController extends Controller
{
    /**
    ...
    {
        $values = invUom::orderBy('id', 'desc')->get();

        return view('inventdashboard.unitsOfMeasurements')->with('values', $values);
    }
