...
class RegisteredUserController extends Controller
{
    ...
    {
        $users = User::with('employee:id,surname,first_name,emp_id,prefix,email,contact,status')->latest()->get();
        $deptCount = Department::where('type', '=', 'Department')->orWhere('type', '=', 'Unit')->orWhere('type', '=', 'Laboratory')->count();
        $stationCount = Station::count();
        $logs = ActivityLog::count();

        return view('super-admin.dashboard', compact('users', 'deptCount', 'stationCount', 'logs'));
    }
    ...
    {
        $employee = Employee::select('id', 'surname', 'first_name', 'emp_id', 'prefix', 'email', 'contact')->where('emp_id', $emp_id)->get();
